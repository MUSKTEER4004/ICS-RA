<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="testList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="网络地址" align="center" prop="address" />
      <el-table-column label="设备名称" align="center" prop="name" />
      <el-table-column label="设备类型" align="center" prop="type" />
      <el-table-column label="风险值" align="center" prop="risk" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="网络地址" prop="address">
          <el-input v-model="form.address" placeholder="请输入网络地址" />
        </el-form-item>
        <el-form-item label="设备名称" prop="name">
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除ICS测试类编号为"' + ids + '"的数据项？').then(function() {
        return delTest(ids);
      }).then(() => {
        this.getList();
